...
class ListsViewController: UIViewController {
    ...
    @IBOutlet private weak var containerViewForAlert: UIView!
...
extension ListsViewController: CreateNewListAlertDelegate {
    ...
    func startAnimationForAlert(key animation: AlertAnimationKeys) {
        ...
        case .show:
            delegate?.listsViewController(self,
                                          didShowAlertView: containerViewForAlert,
                                          visualEffectView: visualEffectView,
                                          scale: scale,
                                          duration: duration)
        case .hide:
            delegate?.listsViewController(self,
                                          didHideAlertView: containerViewForAlert,
                                          visualEffectView: visualEffectView,
                                          scale: scale,
                                          duration: duration)
        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if userLists.isEmpty {
            ...
            if indexPath.item == numberOfUserLists {
                delegate?.listsViewController(self, didTapSetupAlertView: containerViewForAlert,
                                              with: containerViewHeight)
