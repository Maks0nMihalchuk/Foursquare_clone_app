...
protocol UpNavigaitonViewScrollviewDelegate: class {
...
public class UpNavigationViewAnimation: UIView {

    weak var scrollviewMethod: UpNavigaitonViewScrollviewDelegate?
...
extension UpNavigationViewAnimation: UpNavigaitonViewScrollviewDelegate {
    ...
    public func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
        ...
        guard isAllowTopbarAnimation else { return }
        /*
...
extension UpNavigationViewAnimation {
